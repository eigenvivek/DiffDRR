...
# %% ../notebooks/api/04_visualization.ipynb #3b34c0d9
...
# %% ../notebooks/api/04_visualization.ipynb #5bbd598c
import torch
...
# %% ../notebooks/api/04_visualization.ipynb #0999c1ac-0aa0-4f8e-821e-431f6dfb6819
def plot_mask(
    img: torch.Tensor,
...
# %% ../notebooks/api/04_visualization.ipynb #b1ffbd7c-12eb-48a1-8979-cdf493831a02
def plot_img_and_mask(
    ...
    **imshow_kwargs,
    ...
    axs = plot_drr(img.sum(dim=1, keepdim=True), title, ticks, axs, cmap, **imshow_kwargs)
    if len(axs) == 1:
        axs = axs[0]
    plot_mask(img[:, 1:], axs=axs, alpha=alpha)
    return axs

# %% ../notebooks/api/04_visualization.ipynb #15b1931b
import pathlib
...
# %% ../notebooks/api/04_visualization.ipynb #b6718de4-26c6-4550-9d88-780fa5b809f6
import pyvista
import vtk
...
# %% ../notebooks/api/04_visualization.ipynb #94bce480-3f93-49ba-bdd5-8677ac1e8bde
def drr_to_mesh(
...
# %% ../notebooks/api/04_visualization.ipynb #422595b9-3f28-4c0e-b549-837c8d87430d
...
# %% ../notebooks/api/04_visualization.ipynb #49bec80c-947e-4b66-8205-c540a1342f4a
...
# %% ../notebooks/api/04_visualization.ipynb #fbb0de96-4efa-46ff-a337-3771c9a343e0
import numpy as np
...
# %% ../notebooks/api/04_visualization.ipynb #ebb5fe6b-886c-415a-8881-5387269f7950
def visualize_scene(
    drr: DRR,
    pose: RigidTransform,
    labelmap: bool = False,
