...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'diffdrr.data': { 'diffdrr.data.load_example_ct': ('api/data.html#load_example_ct', 'diffdrr/data.py'),
            ...
            'diffdrr.detector': { 'diffdrr.detector.Detector': ('api/detector.html#detector', 'diffdrr/detector.py'),
                                  ...
                                  'diffdrr.detector._convert_to_rotation_matrix': ( 'api/detector.html#_convert_to_rotation_matrix',
                                                                                    'diffdrr/detector.py'),
            ...
            'diffdrr.utils': { 'diffdrr.utils._10vec_to_4x4symmetric': ('api/utils.html#_10vec_to_4x4symmetric', 'diffdrr/utils.py'),
                               'diffdrr.utils.quaternion_adjugate_to_matrix': ( 'api/utils.html#quaternion_adjugate_to_matrix',
                                                                                'diffdrr/utils.py'),
                               'diffdrr.utils.rotation_10d_to_matrix': ('api/utils.html#rotation_10d_to_matrix', 'diffdrr/utils.py')},
