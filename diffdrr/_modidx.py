...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'diffdrr.data': { 'diffdrr.data.canonicalize': ('api/data.html#canonicalize', 'diffdrr/data.py'),
            ...
            'diffdrr.reconstruction': { 'diffdrr.reconstruction.grid_splat': ( 'api/reconstruction.html#grid_splat',
                                                                               'diffdrr/reconstruction.py'),
                                        'diffdrr.reconstruction.splat_points_nearest': ( 'api/reconstruction.html#splat_points_nearest',
                                                                                         'diffdrr/reconstruction.py'),
                                        'diffdrr.reconstruction.splat_points_trilinear': ( 'api/reconstruction.html#splat_points_trilinear',
                                                                                           'diffdrr/reconstruction.py')},
