...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'diffdrr.data': { 'diffdrr.data.load_example_ct': ('api/data.html#load_example_ct', 'diffdrr/data.py'),
            ...
            'diffdrr.renderers': { 'diffdrr.renderers.Siddon': ('api/renderers.html#siddon', 'diffdrr/renderers.py'),
                                   ...
                                   'diffdrr.renderers.Siddon.spacing': ('api/renderers.html#siddon.spacing', 'diffdrr/renderers.py'),
                                   'diffdrr.renderers.Siddon.volume': ('api/renderers.html#siddon.volume', 'diffdrr/renderers.py'),
