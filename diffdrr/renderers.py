...
# %% ../notebooks/api/01_renderers.ipynb #05efb54f
import torch
from torch.nn.functional import grid_sample

# %% ../notebooks/api/01_renderers.ipynb #47f1b4c7
...
# %% ../notebooks/api/01_renderers.ipynb #08f6261c
def _get_alphas(source, target, dims, voxel_shift, eps, filter_intersections_outside_volume):
...
# %% ../notebooks/api/01_renderers.ipynb #08a29306
...
# %% ../notebooks/api/01_renderers.ipynb #8ed6005d
class Trilinear(torch.nn.Module):
    ...
    def forward(
        ...
        if alphamin is None or alphamax is None:
            alphamin, alphamax = _get_alpha_minmax(source, target, dims, self.voxel_shift, self.eps)
