# AUTOGENERATED! DO NOT EDIT! File to edit: ../notebooks/api/02_camera.ipynb.

# %% auto 0
__all__ = ['Detector']

# %% ../notebooks/api/02_camera.ipynb 3
import torch
from fastcore.basics import patch
from torch.nn.functional import normalize

# %% ../notebooks/api/02_camera.ipynb 5
class Detector:
    ...
    def __init__(
        ...
        n_subsample: int | None,  # Number of target points to randomly sample
    ):
        self.height = height
        self.width = width
        self.delx = delx
...
# %% ../notebooks/api/02_camera.ipynb 6
@patch
def make_xrays(
    self: Detector,
